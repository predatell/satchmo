...
class TaxRate(models.Model):
    ...
    taxZone = models.ForeignKey(AdminArea, blank=True, null=True, on_delete=models.SET_NULL, verbose_name=_('Tax Zone'))
    taxCountry = models.ForeignKey(Country, blank=True, null=True, on_delete=models.SET_NULL, verbose_name=_('Tax Country'))
    ...
    def __str__(self):
        return "%s - %s = %s" % (self.taxClass, self.taxZone and self.taxZone or self.taxCountry, self.display_percentage)
